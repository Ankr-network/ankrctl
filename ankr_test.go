...
func TestUserAgent(t *testing.T) {
	...
	AnkrVersion = Version{Major: 0, Minor: 1, Patch: 2}

	assert.Equal(t, "dccncli/0.1.2", userAgent())
}
...
func TestVersion(t *testing.T) {
	...
	cases := []struct {
		...
		// version with release label and released version available
		{
			...
			s:   "dccncli version 1.0.0-release",
			ver: `1.0.0-release`,
			slr: slr2,
		},
	}
