...
func TestKeysCreate(t *testing.T) {
	withTestClient(t, func(config *CmdConfig, tm *tcMocks) {
		...
		config.Ankr.Set(config.NS, dccncli.ArgKeyPublicKey, "fingerprint")
...
func TestKeysUpdateByID(t *testing.T) {
	withTestClient(t, func(config *CmdConfig, tm *tcMocks) {
		...
		config.Ankr.Set(config.NS, dccncli.ArgKeyName, "the key")
...
func TestSSHPublicKeyImportWithName(t *testing.T) {
	...
	withTestClient(t, func(config *CmdConfig, tm *tcMocks) {
		...
		config.Ankr.Set(config.NS, dccncli.ArgKeyPublicKeyFile, path)
