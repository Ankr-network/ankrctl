...
// SnapshotsService is an interface for interacting with AnkrNetwork's snapshot api.
type SnapshotsService interface {
	List() (Snapshots, error)
	ListVolume() (Snapshots, error)
	ListTask() (Snapshots, error)
...
func (ss *snapshotsService) ListTask() (Snapshots, error) {
	f := func(opt *godo.ListOptions) ([]interface{}, *godo.Response, error) {
		list, resp, err := ss.client.Snapshots.ListTask(context.TODO(), opt)
		if err != nil {
			return nil, nil, err
		}
